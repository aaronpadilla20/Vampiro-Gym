    ...
    public partial class splashWindow : Form
    {
        ...
        private void loading()
        {
            ...
            if (InvokeRequired)
            {
                ...
                {
                    MessageBox.Show("Se ha presentado el siguiente error al intentar inicializar el lector de huellas: " + resConexion, "Error",MessageBoxButtons.OK, MessageBoxIcon.Error);
                    Application.Exit();
                }*/
                #endregion
                ...
                /*
                string resConexion = conexionLector.ConnectDevice();
                if (!resConexion.Contains("Conexion exitos"))
                {
                    MessageBox.Show("Se ha presentado el siguiente error al intentar establecer comunicacion con el lector de huellas: " + resConexion, "Error",MessageBoxButtons.OK, MessageBoxIcon.Error);
                    Application.Exit();
                }*/
                #endregion
                ...
                /*
                string resConexion = conexionLector.CloseConnection();
                if (!resConexion.Contains("Comunicación cerrada exitosamente"))
                {
                    MessageBox.Show("Se ha presentado el siguiente error al intentar cerra la comunicación con el sensor de huellas: " + resConexion,"Error",MessageBoxButtons.OK,MessageBoxIcon.Error);
                    Application.Exit();
                }*/
                #endregion
